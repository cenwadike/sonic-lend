...
export function ModernDashboardLayout({ children }: ModernDashboardLayoutProps) {
  ...
  // Update the navigation array to remove the withdraw item
  const navigation = [
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-background/80 backdrop-blur-sm border-b h-16 flex items-center justify-end px-4">
          <ConnectWalletButton />
        </header>
